...
public class UserService {
    ...
    // Get one user - Borrowing/Deleting from one user
    public User oneUser(Object idObject) {
    	Optional<User> user = userRepo.findById((Long) idObject);
    	return user.get();
    }
    
    //MOVED TO PROJECTSERVICES
//    // Add to Database (Join the team)
...
//    }
    ...
    // Remove from Database (Leave the team)
